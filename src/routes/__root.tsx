...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mageye" },
      { name: "description", content: "Cinematic videography by Mageye." },
      { name: "author", content: "Mageye" },
      { property: "og:title", content: "Mageye" },
      { property: "og:description", content: "Cinematic stories, beautifully captured." },
    ...
    links: [
      ...
      {
        rel: "preconnect",
        href: "https://mageye-hassan-8a3ee-default-rtdb.firebaseio.com",
        crossOrigin: "anonymous",
      },
      {
        rel: "dns-prefetch",
